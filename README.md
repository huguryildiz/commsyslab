...
| 07  | **Digital Modulation & Detection** | M-ary constellations (PSK/QAM/ASK/FSK), AWGN, ML/MAP decision regions, SER curves & optimum receiver (correlation / matched-filter, Gram-Schmidt); DPSK differential encoding & detection; noncoherent square-law FSK; multidimensional orthogonal/biorthogonal/simplex signals with union bound; regenerative-vs-analog repeaters; carrier-phase PLL & symbol-timing (early-late gate) synchronization                                                                     |
