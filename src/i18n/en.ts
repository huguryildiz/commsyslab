export const en: Record<string, string> = {
  ...
  'modulation.sigspace.tab': 'Signal space',
  'modulation.sigspace.preset': 'Signal set',
  'modulation.sigspace.preset.antipodal': 'Binary antipodal (1-D)',
  'modulation.sigspace.preset.qpsk': 'QPSK-like (2-D)',
  'modulation.sigspace.preset.orthogonal': 'Orthogonal pair (2-D)',
  'modulation.sigspace.preset.example711': 'Proakis Ex. 7.1.1 (3-D)',
  'modulation.sigspace.preset.custom': 'Custom (draw your own)',
  'modulation.sigspace.view': 'View',
  'modulation.sigspace.view.walkthrough': 'Walkthrough',
  'modulation.sigspace.view.result': 'Result',
  'modulation.sigspace.reset': 'Reset',
  'modulation.sigspace.panel.walkthrough': 'Gram–Schmidt step',
  'modulation.sigspace.panel.basis': 'Orthonormal basis  $\\varphi_k(t)$',
  'modulation.sigspace.panel.constellation': 'Signal-space constellation',
  'modulation.sigspace.readout.dim': 'Dimension  N / M',
  'modulation.sigspace.readout.step': 'Step',
  'modulation.sigspace.degenerate': 'All signals are zero — there is no basis to show.',
  'modulation.sigspace.legend.source': 'sₘ(t)',
  'modulation.sigspace.legend.proj': 'projection',
  'modulation.sigspace.legend.residual': 'residual gₘ(t)',
  'modulation.sigspace.card.projection.title': 'Projection',
  'modulation.sigspace.card.projection.body':
    'Each signal is projected onto the basis already found; the coefficient $\\langle s_k,\\varphi_j\\rangle$ is how much of $\\varphi_j$ it contains. Subtracting these projections leaves only what is new.',
  'modulation.sigspace.card.basis.title': 'Orthonormal basis',
  'modulation.sigspace.card.basis.body':
    'The basis functions $\\varphi_k(t)$ are mutually orthogonal and unit-energy. Every signal is an exact combination of them, so a waveform becomes a point $s_{mn}$ in an $N$-dimensional space.',
  'modulation.sigspace.card.dimension.title': 'Signal-space dimension',
  'modulation.sigspace.card.dimension.body':
    'Gram-Schmidt yields $N\\le M$ basis functions for $M$ signals. $N$ is the true number of degrees of freedom; extra signals reuse existing dimensions.',
  'modulation.sigspace.card.dependence.title': 'Linear dependence',
  'modulation.sigspace.card.dependence.body':
    'If a signal is fully explained by earlier ones, its residual is zero and it adds no new axis — it is linearly dependent and flagged in the editor.',
  'modulation.sigspace.theory.title': 'Gram-Schmidt orthonormalization (§7.1)',
