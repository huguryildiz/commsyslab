export const en: Record<string, string> = {
  ...
  'landing.mod.deltamod.title': 'Delta Modulation',
  'landing.mod.deltamod.desc': '1-bit delta modulation — staircase tracking, slope overload & granular noise.',
