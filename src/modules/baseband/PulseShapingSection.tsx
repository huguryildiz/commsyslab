    ...
    <div className="module-layout">
      ...
      <div className="baseband__content">
        ...
        <TheoryBox title={t('baseband.theory.pulse')}>
          <p>
            <Formula
              tex="x(t)=\operatorname{sinc}\!\left(\tfrac{t}{T}\right)\frac{\cos(\pi\alpha t/T)}{1-(2\alpha t/T)^2}"
              block
            />
          </p>
          <p>
            <Formula
              tex="\sum_{m=-\infty}^{\infty} X\!\left(f+\tfrac{m}{T}\right)=T\quad\Rightarrow\quad x(nT)=\delta[n]"
              block
            />
          </p>
          <p>
